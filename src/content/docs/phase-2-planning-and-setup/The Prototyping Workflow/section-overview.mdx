...
[**📥 Download the Starter Assets (inventory-assets.zip)**](/public/resources/phase-two/inventory-prototype-assets.zip)
...
Once your development server is running and your `inventory` view is loaded, proceed to the first phase of the build.

[**Continue to Part 1: Building the Layout Structure ➔**](../prototyping-an-inventory-part-one/)