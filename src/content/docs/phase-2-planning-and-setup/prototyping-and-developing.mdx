...
<video autoplay loop muted>
  <source src={hmrPreview} type="video/mp4" />
</video>
...
- <Link>The Vite Gameface style transformer</Link>, a Vite plugin that transforms your inline styles to reusable CSS classes at build time to ensure optimal performance in Gameface.
