...
- **Data Binding** is a Gameface-specific addition covered in detail in the [Custom Inspector Tools](/phase-5-polishing/debugging-profiling--testing/custom-tools) article.
...
The <Highlight>Performance</Highlight> tab records a timeline with Gameface-specific engine markers. These markers are covered in detail in the [Performance & Memory Profiling](/phase-5-polishing/debugging-profiling--testing/performance-and-memory-profiling) article.
...
With the panel inventory and VS Code setup covered, the next article explores the Cohtml and Data Binding panels: Gameface-specific DevTools extensions that surface GPU repaint regions, bind attribute evaluation traces, and live model state directly in the Inspector.
