...
Now that you can control inline SVG geometry and styling at runtime, continue to
[Advanced UI Shapes: 9-Slice, Clipping, and Masking](/phase-3-layout-assets-and-styling/graphics--shapes/advanced-ui-shapes/) to combine scalable
borders, hard shape cuts, and alpha masks for more complex panel construction.
