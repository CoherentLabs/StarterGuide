...
With scalable borders, geometric cuts, and soft masks in place, the next step is handling motion assets with the same level of discipline. Continue to
[Animated Assets: GIFs & Videos](/phase-3-layout-assets-and-styling/animated-assets/) to decide when UI motion should be a video, a sprite sheet, or a
lighter runtime animation.
