...
Now that your text flows naturally alongside icons and emojis, it is time to prepare your UI for a global audience. 

Proceed to the [Auto-Scaling Text for Localization](/phase-3-layout-assets-and-styling/texts--fonts/auto-scaling-text/) article to learn how to dynamically fit differently
sized translated strings into your UI and effortlessly handle Right-to-Left (RTL) languages.