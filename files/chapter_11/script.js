...
function mapDragStart(event) {
    ...
    limitX = map.getBoundingClientRect().width - mapWrapper.getBoundingClientRect().width;
    limitY = map.getBoundingClientRect().height - mapWrapper.getBoundingClientRect().height;
...
function zoom(event) {
    ...
    limitX =
        map.getBoundingClientRect().width * (MapModel.zoom / initialScale) - mapWrapper.getBoundingClientRect().width;
    limitY =
        map.getBoundingClientRect().height * (MapModel.zoom / initialScale) - mapWrapper.getBoundingClientRect().height;
